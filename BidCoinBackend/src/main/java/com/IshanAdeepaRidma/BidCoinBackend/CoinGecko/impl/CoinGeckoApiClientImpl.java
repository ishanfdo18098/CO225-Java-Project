package com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.impl;

import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.CoinGeckoApiService;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.CoinGeckoApi;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.*;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Coins.*;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Events.EventCountries;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Events.EventTypes;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Events.Events;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.ExchangeRates.ExchangeRates;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Exchanges.*;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Global.DecentralizedFinanceDefi;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Global.Global;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Search.Trending;
import com.IshanAdeepaRidma.BidCoinBackend.CoinGecko.domain.Status.StatusUpdates;
...
public class CoinGeckoApiClientImpl implements CoinGeckoApiClient {
    ...
    @Override
    public Map<String, Map<String, Double>> getPrice(String ids, String vsCurrencies, boolean includeMarketCap,
            boolean include24hrVol, boolean include24hrChange, boolean includeLastUpdatedAt) {
        return coinGeckoApi.executeSync(coinGeckoApiService.getPrice(ids, vsCurrencies, includeMarketCap,
    ...
    @Override
    public Map<String, Map<String, Double>> getTokenPrice(String id, String contractAddress, String vsCurrencies,
            boolean includeMarketCap, boolean include24hrVol, boolean include24hrChange, boolean includeLastUpdatedAt) {
        return coinGeckoApi.executeSync(coinGeckoApiService.getTokenPrice(id, contractAddress, vsCurrencies,
    ...
    @Override
    public List<CoinMarkets> getCoinMarkets(String vsCurrency, String ids, String order, Integer perPage, Integer page,
            boolean sparkline, String priceChangePercentage) {
        return coinGeckoApi.executeSync(coinGeckoApiService.getCoinMarkets(vsCurrency, ids, order, perPage, page,
    ...
    @Override
    public CoinFullData getCoinById(String id, boolean localization, boolean tickers, boolean marketData,
            boolean communityData, boolean developerData, boolean sparkline) {
        return coinGeckoApi.executeSync(coinGeckoApiService.getCoinById(id, localization, tickers, marketData,
                communityData, developerData, sparkline));
    }
    ...
    @Override
    public Events getEvents(String countryCode, String type, Integer page, boolean upcomingEventsOnly, String fromDate,
            String toDate) {
        return coinGeckoApi.executeSync(
                coinGeckoApiService.getEvents(countryCode, type, page, upcomingEventsOnly, fromDate, toDate));
    }
